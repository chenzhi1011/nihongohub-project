...
export const translations: TranslationMap = {
  ...
  learningCheckin: { zh: '学习打卡', jp: '学習チェック' },
  checkinMonthLabel: { zh: '{month}月', jp: '{month}月' },
  ...
  loginEmailOtp: { zh: '邮箱验证码登录', jp: 'メール認証コードでログイン' },
  emailOtpTitle: { zh: '邮箱验证码登录', jp: 'メール認証コードでログイン' },
  emailAddress: { zh: '邮箱地址', jp: 'メールアドレス' },
  emailPlaceholder: { zh: 'you@example.com', jp: 'you@example.com' },
  sendEmailOtp: { zh: '发送验证码', jp: '認証コードを送信' },
  emailOtpSending: { zh: '正在发送…', jp: '送信しています…' },
  emailOtpSentTo: { zh: '验证码已发送至 {email}', jp: '{email} に認証コードを送信しました' },
  emailOtpCode: { zh: '6 位验证码', jp: '6桁の認証コード' },
  emailOtpCodePlaceholder: { zh: '请输入验证码', jp: '認証コードを入力' },
  verifyEmailOtp: { zh: '验证并登录', jp: '認証してログイン' },
  emailOtpVerifying: { zh: '正在验证…', jp: '確認しています…' },
  resendEmailOtpIn: { zh: '{seconds} 秒后可重新发送', jp: '{seconds}秒後に再送できます' },
  resendEmailOtp: { zh: '重新发送验证码', jp: '認証コードを再送' },
  emailOtpResent: { zh: '验证码已重新发送。', jp: '認証コードを再送しました。' },
  changeEmail: { zh: '更换邮箱', jp: 'メールアドレスを変更' },
  backToLoginMethods: { zh: '返回登录方式', jp: 'ログイン方法に戻る' },
  authOr: { zh: '或者', jp: 'または' },
  ...
  spaceEmpty: { zh: '你的 Space 还是空的。Mark 公共资源或者添加私人资源后，它们会出现在这里。', jp: 'Spaceはまだ空です。公開リソースをMarkするまたは個人の非公開リソースを追加すると、ここに表示されます。' },
  recentHistory: { zh: '浏览历史', jp: '閲覧履歴' },
  noBrowsingHistory: { zh: '还没有浏览记录', jp: '閲覧履歴はまだありません' },
  myResources: { zh: '我的资源', jp: 'マイリソース' },
